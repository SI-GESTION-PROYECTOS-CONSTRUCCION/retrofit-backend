...
public interface InventoryTransactionRepository extends JpaRepository<InventoryTransaction, Long> {
        ...
        // vista operativa)
        List<InventoryTransaction> findByProjectIdAndResourceIdOrderByTransactionDateDesc(Long projectId,
                        Long resourceId);

        // 2. Cálculo del Stock Físico Actual (Stock = Suma de INBOUND - Suma de
        // OUTBOUND)
        ...
        // 3. Gasto Real Integrado (Suma todas las salidas asociadas a una partida y
        // recurso)
        ...
        BigDecimal calculateConsumedQuantityByProjectItem(@Param("projectItemId") Long projectItemId,
        ...
        Page<StockSummaryDTO> getProjectStockSummary(@Param("projectId") Long projectId, @Param("search") String search,
                        Pageable pageable);

        // 6. Obtener la suma de INGRESOS (INBOUND) para los materiales de un proyecto
        // (Para Control de Abastecimiento)
