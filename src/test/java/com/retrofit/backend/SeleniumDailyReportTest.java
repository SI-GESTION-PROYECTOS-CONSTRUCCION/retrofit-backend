        ...
        public static void main(String[] args) {
                ...
                try {
                        ...
                        ((JavascriptExecutor) driver).executeScript(
                                        "arguments[0].value='40'; arguments[0].dispatchEvent(new Event('input'));",
                                        laborYield);
                        ...
                        WebElement squadInput = driver
                                        .findElement(By.xpath(
                                                        "//td/input[contains(@class, 'cell-input') and not(@disabled)]"));
                        ((JavascriptExecutor) driver).executeScript(
                                        "arguments[0].value='2'; arguments[0].dispatchEvent(new Event('input'));",
                                        squadInput);
                        ...
                        Thread.sleep(5000);
                        WebElement btnGuardarPto = driver
                                        .findElement(By.xpath("//button[contains(., 'Guardar Presupuesto')]"));
                        ...
                        driver.get("https://retrofit-nxaez.ondigitalocean.app/portafolio/proyecto/110/daily-report");
                        ...
                        WebElement selectElement = driver
                                        .findElement(By.xpath("//select[@formControlName='projectItemId']"));
                        Select itemSelect = new Select(selectElement);
                        itemSelect.selectByIndex(1);
                        Thread.sleep(5000);
                        WebElement quantityInput = driver
                                        .findElement(By.xpath("//input[@formControlName='executedQuantity']"));
                        quantityInput.sendKeys("20.5");
                        WebElement obsInput = driver
                                        .findElement(By.xpath("//textarea[@formControlName='observations']"));
                        obsInput.sendKeys(
                        ...
                        System.out.println(
                                        "✅ PRUEBA EXITOSA: El avance físico diario se registró en la obra correctamente.");
